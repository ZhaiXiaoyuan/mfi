                    ...
                    <table class="cm-entry-list">
                        ...
                        <tr v-for="(item,index) in entryList">
                            ...
                            <td>
                                ...
                                <span class="handle" @click="reSentStudentActivationEmail(item)" v-if="account.type=='school'&&item.studentAccountStatus=='nonActivated'">{{$t('btn.activationEmail')}}</span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
    ...
    export default {
        ...
        methods: {
            getList:function (pageIndex) {
                ...
                let params={
                    ...Vue.sessionInfo(),
                    schoolId:this.account.type=='school'?this.account.id:'',
                ...
                Vue.api.getSchoolStudentList(params).then((resp)=>{
