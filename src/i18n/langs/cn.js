...
const cn = {
    label:{
        ...
        dynamicRoutine: '动态考核',
        staticRoutine: '静态考核',
        rescuePerformance: '救援考核',
        staticRoutineWOMerFin: '无蹼考核',
        dualRoutine: '双人考核',
        soloPerformance: '个人表演',
        teachingTheory: '教学能力 (理论)',
        teachingStudio: '教学能力 (形体)',
        teachingPool: '教学能力 (泳池)',
        waterSafety: '水下安全',
        freeDiving: '自由潜水员认证',
        scuba: '水肺潜水员认证',
        freeDivingInstuctor: '自由潜水教练认证',
        scubaInstructor: '水肺潜水教练认证',
